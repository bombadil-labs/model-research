...
:root{--v:#6B4FC9;--r:#BE3E6E;--b:#1C7FA8;--ink:#16161C;--mut:#5C5C69;--paper:#FBFAF7;--hair:#E4E1D9;--rule:#15151B}
@media (prefers-color-scheme:dark){:root:not([data-theme="light"]){--v:#7C63D6;--r:#D4577F;--b:#2E92BE;--ink:#ECECF2;--mut:#9A9AA6;--paper:#131318;--hair:#2C2C36;--rule:#ECECF2}}
:root[data-theme="dark"]{--v:#7C63D6;--r:#D4577F;--b:#2E92BE;--ink:#ECECF2;--mut:#9A9AA6;--paper:#131318;--hair:#2C2C36;--rule:#ECECF2}
...
.wrap{max-width:1180px;margin:0 auto;padding:0 clamp(16px,4vw,84px)}
...
.band{border-top:2px solid var(--rule);padding:clamp(28px,4vw,44px) 0}
...
h1.q{margin:10px 0 14px;font-size:clamp(28px,4.4vw,42px);line-height:1.12;max-width:20ch}
h2.s{margin:8px 0 8px;font-size:clamp(24px,3.2vw,34px)}
.claims{list-style:none;margin:20px 0 0;padding:0}
.claims li{display:grid;grid-template-columns:22px 1fr 170px 78px;gap:16px;align-items:start;padding:13px 0;border-bottom:1px solid var(--hair)}
